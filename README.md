...
Run all the tests with Maven run command $ mvn clean test. If you use clean , all the resources and compiled java code generated by maven in target directory will be cleaned and run tests freshly.

 6. The other way to run all tests. Open Intellij and run testng.xml file.
